...
#+AUTHOR: Fabio Kleis
#+DATE: 2026-04-12
#+DESCRIPTION: Documentação do trabalho sistema promoção: Microsserviços, Sistema de Mensageria, Criptografia de Chave Assimétrica, API REST.
...
docker run --detach --hostname rabbitmq --name promocao-rabbitmq \
    ...
    --publish 5672:5672 \
     rabbitmq:management
#+END_SRC
para executar o mailpit para envio de email localmente:
#+BEGIN_SRC bash
docker run -d \
...
** Exemplo trabalho 2
[[file:promocao.png][frontend]]
[[file:mailpit.png][email]]
